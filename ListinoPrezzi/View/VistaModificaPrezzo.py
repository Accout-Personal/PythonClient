...
import ListinoPrezzi.View.VistaListaListinoPrezzi as list
from ListinoPrezzi.Controller.ListinoPrezziC import ListinoPrezziC
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtWidgets import QMessageBox, QWidget
import copy

class Ui_ModificaPrezzo(QWidget):
    def __init__(self,key, parent=None):
        super(Ui_ModificaPrezzo, self).__init__(parent)
    ...
    def Modify(self):
        ...
        if('message' in self.risultato):
            ...
            self.OpenLista = list.Ui_ListaListinoPrezzi()
            self.OpenLista.show()
            self.close()
