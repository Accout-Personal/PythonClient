...
class Ui_InserisciListinoPrezzi(QWidget):
    def __init__(self, parent=None):
        super(Ui_InserisciListinoPrezzi, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        
        self.controller = ListinoPrezziC()
        InsertWindow = self
        InsertWindow.setWindowTitle(self._translate("InserisciCliente", "Inserisci un nuovo modello"))
        InsertWindow.setObjectName("Inserisci un nuovo modello")
