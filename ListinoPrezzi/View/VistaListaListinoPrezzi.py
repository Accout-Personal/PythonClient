...
from ListinoPrezzi.View.VistaModificaPrezzo import Ui_ModificaPrezzo
...
class Ui_ListaListinoPrezzi(QWidget):
    def __init__(self, parent=None):
        ...
        ListaWindow.setWindowTitle(self._translate("ListaWindow", "Lista dei Modelli"))
        ...
        self.AddLabelTitolo("Lista dei Modelli")
    ...
    def deleteConfirm(self,element):

        msg = QMessageBox()
        msg.setWindowTitle('Conferma')
        msg.setText('sei sicuro di voler cancellare il modello '+element['modello'] + '?')
        ...
        if(msg.clickedButton() == okButton):
            ...
            postbody = {'modello':element['modello']}
    ...
    def Modify(self,elem):
       self.Modifica = Ui_ModificaPrezzo(elem['modello'])
       self.Modifica.show()
       self.close() 
