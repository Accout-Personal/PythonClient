...
class Ui_ModificaLavoro(QWidget):
    def __init__(self,keys, parent=None):
        super(Ui_ModificaLavoro, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        self.key = {'dipendente':keys['dipendente']['CF'],
                        'commessa':keys['commessa']}
    ...
    def Modify(self):
        ...
        if('message' in self.risultato):
            ...
            self.OpenLista = ListView.Ui_ListaLavoro()
            self.OpenLista.show()
            self.close()
