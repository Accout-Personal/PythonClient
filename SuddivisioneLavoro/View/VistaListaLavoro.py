...
from SuddivisioneLavoro.View.VistaLavoro import Ui_VistaLavoro
...
class Ui_ListaLavoro(QWidget):
    ...
    def deleteConfirm(self,elemento):
        ...
        msg.setText('sei sicuro di voler cancellare la commessa '+elemento['numero_commessa'] + '?')
        ...
        if(msg.clickedButton() == okButton):
            ...
            postbody = {'dipendente':elemento['dipendente'],
                        'commessa':elemento['dipendente']}
    ...
    def Visualizza(self,elem):
        print(elem)
        self.Dettaglio = Ui_VistaLavoro(str(elem))
        self.Dettaglio.show()
