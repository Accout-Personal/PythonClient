...
class Ui_InserisciAltraSpesa(QWidget):
    def __init__(self, parent=None):
        super(Ui_InserisciAltraSpesa, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        
        self.controller = AltraSpesaC()
        InsAltraSpesa = self
        InsAltraSpesa.setWindowTitle(self._translate("InserisciAltraSpesa", "InserisciAltraSpesa"))
        InsAltraSpesa.setObjectName("InserisciAltraSpesa")
        InsAltraSpesa.resize(800, 600)
        self.verticalLayout = QtWidgets.QVBoxLayout(InsAltraSpesa)
        ...
        QtCore.QMetaObject.connectSlotsByName(InsAltraSpesa)
    ...
    def AddLabelCampo(self,text):
        ...
        self.label_3.setText(self._translate("InsAltraSpesa", "  "+str(text)))
    ...
    def AddLabelDescrizione(self,text):
        ...
        self.label_2.setText(self._translate("InsAltraSpesa",text))
    ...
    def AddLabelTitolo(self,text):
        ...
        self.label.setText(self._translate("InsAltraSpesa", text))
