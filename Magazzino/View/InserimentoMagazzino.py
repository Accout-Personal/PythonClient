...
class Ui_InserisciMagazzino(QWidget):
    def __init__(self, parent=None,fakeparent=None):
        ...
        InsMagazzino.setObjectName("InserisciMagazzino")
        InsMagazzino.resize(800, 600)
        self.verticalLayout = QtWidgets.QVBoxLayout(InsMagazzino)
        ...
        self.traduzione = {
            'tipo_scorta': ' Nome dell\'articolo *',
        }
        ...
        QtCore.QMetaObject.connectSlotsByName(InsMagazzino)
    ...
    def AddButton(self,text,function):
        ...
        self.pushButton.setText(self._translate("InsMagazzino", text))
    ...
    def AddLabelCampo(self,text):
        ...
        self.label_3.setText(self._translate("InsMagazzino", "  "+str(text)))
    ...
    def AddLabelDescrizione(self,text):
        ...
        self.label_2.setText(self._translate("InsMagazzino",text))
