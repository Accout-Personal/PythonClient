...
import copy
import Stipendio.View.StipendioV as Vista

class Ui_ModificaStipendio(QWidget):
    def __init__(self,keys, parent=None):
        super(Ui_ModificaStipendio, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        self.keys = {'dipendente':keys['dipendente_stip'],
                        'data':keys['data']}
        ...
        ModificaWindow.setWindowTitle(self._translate("ModificaWindow", "ModificaStipendio"))
        self.verticalLayout = QtWidgets.QVBoxLayout(ModificaWindow)
        self.verticalLayout.setObjectName("verticalLayout")

        #Aggiunge il "titolo" della finestra
        self.AddLabelTitolo("Modifica stipendio")
        ...
        self.traduzione = {
            'data':'data *',
            'dipendente_stip': 'Codice fiscale *',
