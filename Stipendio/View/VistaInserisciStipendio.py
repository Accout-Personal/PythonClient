...
class Ui_InserisciStipendio(QWidget):
    def __init__(self, parent=None):
        super(Ui_InserisciStipendio, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        
        self.controller = StipendioC()
        InsStipendio = self
        InsStipendio.setWindowTitle(self._translate("InserisciStipendio", "Inserisci Stipendio"))
        InsStipendio.setObjectName("InserisciStipendio")
        InsStipendio.resize(800, 600)
        self.verticalLayout = QtWidgets.QVBoxLayout(InsStipendio)
        ...
        self.traduzione = {
            ...
            'giorni_ferie':'giorni di ferie ',
            'ore_straordinario':'ore di straordinario',
            'ore_lavoro':'ore di lavoro'
        }
    ...
    def AddButton(self,text,function):
        ...
        self.pushButton.setText(self._translate("InsStipendio", text))
    ...
    def AddLabelCampo(self,text):
        ...
        self.label_3.setText(self._translate("InsStipendio", "  "+str(text)))
    ...
    def AddLabelDescrizione(self,text):
        ...
        self.label_2.setText(self._translate("InsStipendio",text))
    ...
    def AddLabelTitolo(self,text):
        ...
        self.label.setText(self._translate("InsStipendio", text))
