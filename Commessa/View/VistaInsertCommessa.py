...
class Ui_InsertCommessa(QWidget):
    def __init__(self, parent=None):
        super(Ui_InsertCommessa, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        
        self.controller = CommessaC()
        InsertWindow = self
        InsertWindow.setWindowTitle(self._translate("InserisciCliente", "Inserisci una nuova commessa"))
        InsertWindow.setObjectName("IInserisci una nuova commessa")
        ...
        self.traduzione = {
            'numero_commessa':'numero commessa *',
            'listino_prezzi_modello':'modello *',
            'nddt_cliente':'ddt d\'ingresso *',
            'data':'data del ddt d\'ingresso *',
            'cliente':'cliente *',
            'Qta':'quantita\' *',
            'tessuto':'tessuto',
        }
