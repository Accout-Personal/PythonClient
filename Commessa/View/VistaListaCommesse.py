...
from Commessa.View.VistaCommessa import Ui_VistaCommessa
from Commessa.View.VistaModificaCommessa import Ui_ModificaCommessa

from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtWidgets import QMessageBox, QWidget
from win32api import GetSystemMetrics # per prendere la risoluzione dello schermo computer

class Ui_ListaCommesse(QWidget):
    def __init__(self, parent=None):
        super(Ui_ListaCommesse, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        ListaView = self
        self.controller = CommessaC()
        self.key = 'codice_merce'
        ...
        'valore_commessa_cliente':'valore commessa',
        ...
        for attr in range(len(self.listAttr)):
            ...
            #casi particolari cliente
            if(self.listAttr[attr]['nome'] == 'cliente'):
                print('attr cliente')
                for a in range(0,len(self.chiamata)):
                    self.AddTableContent(attr,a+1,str(self.chiamata[a]['cliente']['nome_azienda']),self.listAttr[attr]['width'])
            else:
    ...
    def deleteConfirm(self,cliente):
        ...
        if(msg.clickedButton() == okButton):
            ...
            print(res)
            self.RefreshLista = Ui_ListaCommesse()
    ...
    def Visualizza(self,elem):
        print(elem)
        self.Dettaglio = Ui_VistaCommessa(str(elem[self.key]))
        self.Dettaglio.show()
    ...
    def Modify(self,elem):
        print (elem[self.key])
        self.modificaview = Ui_ModificaCommessa(elem[self.key])
