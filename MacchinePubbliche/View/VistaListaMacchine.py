...
from MacchinePubbliche.View.VistaModificaMacchine import Ui_ModificaMacchina
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtWidgets import QMessageBox, QWidget


class Ui_ListaMacchina(QWidget):
    def __init__(self, parent=None):
        super(Ui_ListaMacchina, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        ListaWindow = self
        self.controller = MacchinePubblicheC()
        self.chiamata = self.controller.GetAll()
        ListaWindow.setObjectName("ListaWindow")
        ListaWindow.resize(800, 600)
        ListaWindow.setWindowTitle(self._translate("ListaWindow", "Lista delle Macchine pubbliche"))
        self.verticalLayout = QtWidgets.QVBoxLayout(ListaWindow)
        ...
        self.AddLabelTitolo("Lista delle Macchine pubbliche")



        self.AddScrollArea()
        self.key = 'codice_macchina'
        self.traduzione = {
            'codice_macchina':'il codice della macchina',
            'tipo_macchina':'il tipo della macchina',
        }

        self.listAttr = ['codice_macchina','tipo_macchina']
        ...
        QtCore.QMetaObject.connectSlotsByName(ListaWindow)
    ...
    def deleteConfirm(self,elemento):
        ...
        msg.setText('sei sicuro di voler cancellare il la macchina '+elemento[self.key] + '?')
        ...
        if(msg.clickedButton() == okButton):
            ...
            postbody = {self.key:elemento[self.key]}
            res = self.controller.Delete(postbody)
            print(res)
            self.RefreshLista = Ui_ListaMacchina()
    ...
    def AddTableHeader(self,text,pos,width):
        ...
        self.header1.setText(self._translate("ListaWindow",text))
    ...
    def AddTableContent(self,x,y,content,width):
        ...
        self.label_3.setText(self._translate("ListaWindow","   "+ content))
    ...
    def AddOperationButton(self,x,y,buttonDict,function):
        ...
        OperationButton.setText(self._translate("ListaWindow", buttonDict["name"]))        
    ...
    def Modify(self,elem):
        print (elem[self.key])
        self.modificaview = Ui_ModificaMacchina(elem[self.key])
