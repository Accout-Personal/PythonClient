...
import MacchinePubbliche.View.VistaListaMacchine as list
from MacchinePubbliche.Controller.MacchinePubblicheC import MacchinePubblicheC
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtWidgets import QMessageBox, QWidget
import copy

class Ui_ModificaMacchina(QWidget):
    def __init__(self,key, parent=None):
        super(Ui_ModificaMacchina, self).__init__(parent)
    ...
    def Modify(self):
        ...
        if('message' in self.risultato):
            ...
            self.OpenLista = list.Ui_ListaMacchina()
            self.OpenLista.show()
            self.close()
