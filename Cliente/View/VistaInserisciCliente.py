...
class Ui_InserisciCliente(QWidget):
    def __init__(self, parent=None):
        super(Ui_InserisciCliente, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        
        self.controller = ClienteC()
        InsDipendente = self
        InsDipendente.setWindowTitle(self._translate("InserisciCliente", "InserisciCliente"))
        InsDipendente.setObjectName("InserisciCliente")
