...
class Ui_ModificaEntrata(QWidget):
    def __init__(self,key, parent=None):
        ...
        ModificaWindow.setWindowTitle(self._translate("ModificaWindow", "ModificaEntrata"))
        self.verticalLayout = QtWidgets.QVBoxLayout(ModificaWindow)
        self.verticalLayout.setObjectName("verticalLayout")

        #Aggiunge il "titolo" della finestra
        self.AddLabelTitolo("Modifica Entrata")
        ...
        self.body = {
            'numero_fattura': self.chiamata['numero_fattura'],
            'data': None,
        ...
        self.exclude = ['numero_fattura','importo_entrata','contabile']
