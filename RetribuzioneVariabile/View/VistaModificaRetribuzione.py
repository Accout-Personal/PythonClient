...
import copy
import RetribuzioneVariabile.View.RetribuzioneVariabileV as Vista

class Ui_Modificaretribuzione(QWidget):
    def __init__(self,keys, parent=None):
        super(Ui_Modificaretribuzione, self).__init__(parent)
        ...
        ModificaWindow.setWindowTitle(self._translate("ModificaWindow", "ModificaRetribuzione"))
        self.verticalLayout = QtWidgets.QVBoxLayout(ModificaWindow)
        self.verticalLayout.setObjectName("verticalLayout")

        #Aggiunge il "titolo" della finestra
        self.AddLabelTitolo("Modifica retribuzione")
        ...
        self.traduzione = {
            'data':'data *',
            'dipendente_retr': 'Codice fiscale *',
        }
        ...
        self.exclude = ['importo_retribuzione','dipendente','transazione_retribuzione']
    ...
    def Modify(self):
        ...
        if('message' in self.risultato):
            ...
            self.OpenLista = Vista.Ui_ListaRetribuzioniVariabili()
            self.OpenLista.show()
            self.close()
