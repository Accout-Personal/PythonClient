...
class Ui_InserisciRetribuzionevariabile(QWidget):
    def __init__(self, parent=None):
        super(Ui_InserisciRetribuzionevariabile, self).__init__(parent)
        self._translate = QtCore.QCoreApplication.translate
        
        self.controller = RetribuzioneVariabileC()
        InsRetribuzione = self
        InsRetribuzione.setWindowTitle(self._translate("InserisciRetribuzione", "Inserisci retribuzione"))
        InsRetribuzione.setObjectName("InserisciRetribuzione")
        InsRetribuzione.resize(800, 600)
        self.verticalLayout = QtWidgets.QVBoxLayout(InsRetribuzione)
        ...
        QtCore.QMetaObject.connectSlotsByName(InsRetribuzione)
    ...
    def AddLabelCampo(self,text):
        ...
        self.label_3.setText(self._translate("InsRetribuzione", "  "+str(text)))
    ...
    def AddLabelDescrizione(self,text):
        ...
        self.label_2.setText(self._translate("InsRetribuzione",text))
    ...
    def AddLabelTitolo(self,text):
        ...
        self.label.setText(self._translate("InsRetribuzione", text))
