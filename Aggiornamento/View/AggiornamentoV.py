...
class Ui_ListaAggiornamenti(QWidget):
    def __init__(self, parent=None,fakeparent = None):
        ...
        ListaAggiornamenti.resize(800, 600)
        ListaAggiornamenti.setWindowTitle(self._translate("ListaAggiornamenti", "ListaAggiornamenti"))
        self.verticalLayout = QtWidgets.QVBoxLayout(ListaAggiornamenti)
        ...
        QtCore.QMetaObject.connectSlotsByName(ListaAggiornamenti)

    #chiamata alla funzione per la cancellazione di un elemento
    def deleteConfirm(self,aggiornamento):

        msg = QMessageBox()
        msg.setWindowTitle('Conferma')
        msg.setText("sei sicuro di voler cancellare l' Aggiornamento "+str(aggiornamento['id']) + ' ?')
    ...
    def AddTableHeader(self,text,pos,width):
        ...
        self.header1.setText(self._translate("ListaAggiornamenti",text))
    ...
    def AddTableContent(self,x,y,content,width):
        ...
        self.label_3.setText(self._translate("ListaAggiornamenti","   "+ str(content)))
    ...
    def AddOperationButton(self,x,y,buttonDict,function):
        ...
        OperationButton.setText(self._translate("ListaAggiornamenti", buttonDict["name"]))        
